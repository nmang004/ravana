...
export default function PortsmouthWebDevelopmentPage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <RevealOnScroll delay={0.2}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Stand out in Portsmouth&apos;s competitive market with a custom website that attracts
                customers, builds credibility, and drives measurable growth. From downtown
                businesses to waterfront enterprises, we create digital experiences that convert.
              </p>
            </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We understand Portsmouth&apos;s unique business landscape—from the defense and
                maritime industries to downtown retail and hospitality. Our websites are built to
                succeed in your specific market.
              </p>
            </div>
          </RevealOnScroll>
            ...
            {[
              {
                ...
                description:
                  'Deep understanding of Portsmouth customer behavior and competitive landscape.',
              },
              {
                icon: Rocket,
              ...
              },
              {
                ...
                title: 'ROI-Focused',
                description:
                  'Every design decision is made to maximize your return on investment.',
              },
              {
                icon: Code2,
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    'SEO Optimization for Portsmouth Search Results',
            ...
            {[
              {
                ...
                title: 'Discovery',
                description:
                  'We learn about your business, goals, and Portsmouth market position.',
              },
              {
                step: '02',
                title: 'Strategy',
