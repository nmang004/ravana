...
export default function ChesapeakeDigitalMarketingPage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <RevealOnScroll delay={0.2}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Capture the attention of Chesapeake&apos;s 16 million annual visitors and affluent local market. Our proven digital marketing campaigns help businesses increase bookings, drive sales, and maximize ROI through targeted social media, PPC, and email marketing.
              </p>
            </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Chesapeake&apos;s unique blend of tourism and local business demands sophisticated marketing. We create campaigns that convert both seasonal visitors and year-round residents into loyal customers.
              </p>
            </div>
          </RevealOnScroll>
            ...
            <RevealOnScroll>
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Our full-service digital marketing approach combines multiple channels to create campaigns that attract, engage, and convert Chesapeake customers into loyal advocates for your brand.
                </p>
            ...
            {[
              {
                ...
                description:
                  'Analyze your market, competitors, and customer behavior in Chesapeake.',
              },
              {
                step: '02',
