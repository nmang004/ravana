...
export default function VirginiaBeachDigitalMarketingPage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <RevealOnScroll delay={0.2}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Capture the attention of Virginia Beach&apos;s 16 million annual visitors and affluent local market. Our proven digital marketing campaigns help businesses increase bookings, drive sales, and maximize ROI through targeted social media, PPC, and email marketing.
              </p>
            </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Virginia Beach&apos;s unique blend of tourism and local business demands sophisticated marketing. We create campaigns that convert both seasonal visitors and year-round residents into loyal customers.
              </p>
            </div>
          </RevealOnScroll>
            ...
            {[
              {
                ...
                description:
                  'Campaigns tailored to peak tourism season and off-season local targeting.',
              },
              {
                icon: TrendingUp,
                title: 'ROI-Focused',
              ...
              },
              {
                ...
                description:
                  'Specialized strategies for hospitality, real estate, and service businesses.',
              },
            ].map((feature, index) => (
            ...
            <RevealOnScroll>
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Our full-service digital marketing approach combines multiple channels to create campaigns that attract, engage, and convert Virginia Beach customers into loyal advocates for your brand.
                </p>
            ...
            {[
              {
                ...
                description:
                  'Analyze your market, competitors, and customer behavior in Virginia Beach.',
              },
              {
                step: '02',
