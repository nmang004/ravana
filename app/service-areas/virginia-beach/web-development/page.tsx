...
export default function VirginiaBeachWebDevelopmentPage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <RevealOnScroll delay={0.2}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Capture the attention of Virginia Beach&apos;s 16 million annual visitors and thriving local market with a stunning website. From oceanfront hotels to Town Center businesses, we create digital experiences that convert browsers into customers.
              </p>
            </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Virginia Beach demands exceptional digital experiences. We specialize in tourism, hospitality, real estate, and service businesses that need to stand out in a competitive coastal market.
              </p>
            </div>
          </RevealOnScroll>
            ...
            {[
              {
                ...
                description:
                  'Specialized in hospitality websites that convert visitors into bookings.',
              },
              {
                icon: Rocket,
                title: 'Fast Performance',
                description:
                  'Lightning-fast load times that keep impatient beachgoers engaged.',
              },
              {
                icon: TrendingUp,
                title: 'Conversion-Focused',
                description:
                  'Every element designed to turn traffic into revenue for your business.',
              },
              {
                icon: Code2,
                title: 'Mobile-First Design',
                description:
                  'Perfect on every device—critical for Virginia Beach&apos;s mobile audience.',
              },
            ].map((feature, index) => (
            ...
            <RevealOnScroll>
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  ...
                  features to ensure you capture and convert your coastal market.
                </p>

                <div className="space-y-4">
                  {[
                    'Mobile-Responsive Design',
                    'SEO Optimization for Virginia Beach Search Results',
            ...
            {[
              {
                ...
                title: 'Discovery',
                description:
                  'We learn about your business, goals, and Virginia Beach market position.',
              },
              {
                step: '02',
                title: 'Strategy',
