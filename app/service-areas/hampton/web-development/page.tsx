...
export default function HamptonWebDevelopmentPage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <RevealOnScroll delay={0.2}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Stand out in Hampton&apos;s competitive market with a custom website that attracts
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We understand Hampton&apos;s unique business landscape—from the defense and
            ...
            {[
              {
                ...
                description:
                  'Deep understanding of Hampton customer behavior and competitive landscape.',
              },
              {
                icon: Rocket,
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    'SEO Optimization for Hampton Search Results',
            ...
            {[
              {
                ...
                title: 'Discovery',
                description:
                  'We learn about your business, goals, and Hampton market position.',
              },
              {
                step: '02',
                title: 'Strategy',
