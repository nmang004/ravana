...
export default function NorfolkWebDevelopmentPage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <RevealOnScroll delay={0.2}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Stand out in Norfolk&apos;s competitive market with a custom website that attracts
            ...
            {[
              {
                ...
                description:
                  'Deep understanding of Norfolk customer behavior and competitive landscape.',
              },
              {
                icon: Rocket,
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    'SEO Optimization for Norfolk Search Results',
            ...
            {[
              {
                ...
                title: 'Discovery',
                description:
                  'We learn about your business, goals, and Norfolk market position.',
              },
              {
                step: '02',
                title: 'Strategy',
