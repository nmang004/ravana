...
export default function NorfolkDigitalMarketingPage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <RevealOnScroll delay={0.2}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Stop wasting marketing budget on guesswork. Our proven digital marketing campaigns help Norfolk businesses attract qualified leads, increase sales, and maximize ROI through social media, PPC, email marketing, and marketing automation.
              </p>
            </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We understand Norfolk&apos;s diverse business landscape—from defense contractors to waterfront hospitality. Our marketing strategies are tailored to connect with Norfolk customers and drive measurable business growth.
              </p>
            </div>
          </RevealOnScroll>
            ...
            {[
              {
                ...
                description:
                  'Reach Norfolk customers at the right time with laser-focused audience targeting.',
              },
              {
                icon: TrendingUp,
                title: 'ROI-Focused',
              ...
              },
              {
                ...
                description:
                  'Deep understanding of Norfolk demographics, competition, and customer behavior.',
              },
            ].map((feature, index) => (
            ...
            <RevealOnScroll>
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Our full-service digital marketing approach combines multiple channels to create campaigns that attract, engage, and convert Norfolk customers into loyal advocates for your brand.
                </p>
            ...
            {[
              {
                ...
                description:
                  'Analyze your market, competitors, and customer behavior in Norfolk.',
              },
              {
                step: '02',
