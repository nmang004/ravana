...
export default function NorfolkSEOPage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <RevealOnScroll delay={0.2}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Get found by Norfolk customers actively searching for your services. Our
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                ...
                paying customers. Our local Norfolk expertise gives you an unfair advantage.
              </p>
            </div>
          </RevealOnScroll>
            ...
            {[
              {
                ...
                description:
                  'Dominate "near me" searches and Norfolk-specific keywords that drive customers.',
              },
              {
                icon: BarChart3,
              ...
              },
              {
                ...
                title: 'Proven Growth',
                description:
                  'Average 150% increase in organic traffic within 6 months for Norfolk clients.',
              },
              {
                icon: Target,
            ...
            <RevealOnScroll>
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  ...
                  to attract and convert Norfolk customers.
                </p>

                <div className="space-y-4">
                  {[
                    'Local SEO & Google Business Profile Optimization',
                    'Keyword Research for Norfolk Market',
            ...
            {[
              {
                ...
                title: 'SEO Audit',
                description:
                  'Comprehensive analysis of your current rankings and opportunities in Norfolk.',
              },
              {
                step: '02',
                title: 'Strategy',
                description:
                  'Custom roadmap targeting keywords that drive Norfolk customers to you.',
              },
              {
                step: '03',
