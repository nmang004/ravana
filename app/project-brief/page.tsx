  ...
  return (
    <PageTransition>
      <div className="pt-20">
        ...
        <section className="py-8 md:py-12 lg:py-16 px-4 md:px-6 bg-muted/20">
          <div className="container mx-auto">
            <RevealOnScroll>
        ...
        <section className="py-12 md:py-16 px-4 md:px-6">
          <div className="container mx-auto max-w-4xl">
            ...
            <RevealOnScroll delay={0.3}>
              <Card className="mt-8 p-4 md:p-6 bg-gradient-to-br from-accent/5 to-accent/10 border-accent/20">
