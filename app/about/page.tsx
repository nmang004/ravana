      ...
      <div className="pt-20">
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  <RevealOnScroll key={index} delay={index * 0.1}>
                    <Card className="p-3 md:p-6 text-center bg-gradient-to-br from-accent/5 to-accent/10 border-accent/20">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6 lg:gap-8">
              {team.map((member, index) => (
                <RevealOnScroll key={index} delay={index * 0.2}>
                  <Card className="p-3 md:p-6 hover:shadow-lg transition-all duration-300 group">
                    <div className="flex items-start space-x-4">
        ...
        <section className="py-12 md:py-16 px-3 md:px-6">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 lg:gap-8 mb-12">
              {services.map((service, index) => {
                const Icon = service.icon;
                return (
                  <RevealOnScroll key={index} delay={index * 0.2}>
                    <Card className="p-3 md:p-6 text-center hover:shadow-lg transition-all duration-300 group border-border hover:border-accent/50">
